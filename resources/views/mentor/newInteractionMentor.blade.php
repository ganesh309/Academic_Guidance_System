    ...
    <!-- Main Content -->
        ...
        <div class="card p-4">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="interaction" id="interaction" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">Problem Understood</label>
                <input type="text" name="problem_understood" id="problem_understood" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">Remedial action taken</label>
                <input type="text" name="remedy" id="remedy" class="form-control" >
            </div>
            <div class="mb-3">
